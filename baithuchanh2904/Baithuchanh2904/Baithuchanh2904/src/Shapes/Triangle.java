...
public class Triangle extends Point {
    ...
    public void nhap() {
        ...
        p3.nhap();
        a = (float) Math
                .sqrt(Math.pow(p1.getHoanhDo() - p2.getHoanhDo(), 2) + Math.pow(p1.getTungDo() - p2.getTungDo(), 2));
        System.out.println("Do dai canh A: " + a);
        b = (float) Math
                .sqrt(Math.pow(p2.getHoanhDo() - p3.getHoanhDo(), 2) + Math.pow(p2.getTungDo() - p3.getTungDo(), 2));
        System.out.println("Do dai canh B: " + b);
        c = (float) Math
                .sqrt(Math.pow(p1.getHoanhDo() - p3.getHoanhDo(), 2) + Math.pow(p1.getTungDo() - p3.getTungDo(), 2));
